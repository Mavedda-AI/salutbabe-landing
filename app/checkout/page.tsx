            ...
            <div className="bg-white p-6 rounded-3xl shadow-sm">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input required type="text" placeholder="Adınız ve Soyadınız" className="w-full bg-neutral-50 border-none rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-pink-500/20 text-neutral-800 transition placeholder:text-neutral-300" />
                </div>
                <div className="space-y-1.5">
                  <label className="text-xs font-bold text-neutral-500 ml-1 uppercase">TELEFON</label>
                  <input required type="tel" placeholder="05XX XXX XX XX" className="w-full bg-neutral-50 border-none rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-pink-500/20 text-neutral-800 transition placeholder:text-neutral-300" />
                </div>
                <div className="md:col-span-2 space-y-1.5">
                  <label className="text-xs font-bold text-neutral-500 ml-1 uppercase">ADRES</label>
                  <textarea required rows={3} placeholder="Mahalle, sokak, bina ve kapı numarası..." className="w-full bg-neutral-50 border-none rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-pink-500/20 text-neutral-800 transition placeholder:text-neutral-300"></textarea>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="p-4 border-2 border-pink-500 rounded-2xl bg-pink-50/30 flex justify-between items-center transition group">
                  <div className="flex items-center gap-4">
                     ...
                     <span className="font-bold text-neutral-800">Kredi Kartı / Banka Kartı</span>
                  </div>
                  <div className="flex gap-2 opacity-60 group-hover:opacity-100 transition duration-300">
                ...
                <div className="space-y-4 pt-4">
                  <div className="space-y-1.5">
                    ...
                    <input required type="text" placeholder="XXXX XXXX XXXX XXXX" className="w-full bg-neutral-50 border-none rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-pink-500/20 text-neutral-800 transition" />
                  </div>
                  <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-neutral-500 ml-1 uppercase">SON KULLANIM</label>
                      <input required type="text" placeholder="AA / YY" className="w-full bg-neutral-50 border-none rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-pink-500/20 text-neutral-800 transition" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-xs font-bold text-neutral-500 ml-1 uppercase">CVV</label>
                      <input required type="text" placeholder="***" className="w-full bg-neutral-50 border-none rounded-xl px-4 py-3.5 focus:ring-2 focus:ring-pink-500/20 text-neutral-800 transition" />
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="w-full lg:w-96">
            <div className="bg-white p-6 rounded-3xl shadow-sm sticky top-32 overflow-hidden border border-neutral-100/50">
              <div className="absolute top-0 right-0 p-2 opacity-5">
                 <svg className="w-20 h-20 text-blue-700" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path></svg>
              </div>
              ...
              <button type="submit" className="w-full py-4 bg-pink-600 text-white rounded-2xl font-bold shadow-xl shadow-pink-100 hover:bg-blue-600 hover:shadow-blue-100 transition duration-300 transform active:scale-[0.98] flex items-center justify-center gap-2">
