...
for (const key in newTranslations.widgets) {
  tr.widgets[key] = newTranslations.widgets[key].tr;
  en.widgets[key] = newTranslations.widgets[key].en;
  de.widgets[key] = newTranslations.widgets[key].de;
  fr.widgets[key] = newTranslations.widgets[key].fr;
}
