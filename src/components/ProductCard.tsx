...
const ProductCard: React.FC<ProductCardProps> = ({ 
  ...
  return (
    ...
    >
      ...
      <div className="px-4">
        <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2">{category}</p>
        <h3 className="text-lg font-black text-slate-900 group-hover:text-primary-blue transition-colors duration-300 leading-tight">{name}</h3>
