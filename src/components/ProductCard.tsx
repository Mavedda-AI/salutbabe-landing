    ...
    >
      <div className="aspect-[4/5] rounded-[2.5rem] bg-surface border border-border-color overflow-hidden relative mb-6 transition-all duration-700 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.12)] hover:-translate-y-3">
        ...
        <div className="absolute top-8 left-8 z-10">
           <button className="w-10 h-10 rounded-full bg-surface/40 backdrop-blur-md flex items-center justify-center border border-white/20 shadow-sm hover:bg-surface transition-all duration-300">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="text-text-secondary">
