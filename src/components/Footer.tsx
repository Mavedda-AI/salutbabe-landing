          ...
          <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-4 md:gap-0">
            ...
            <div>
              <p className="flex items-center gap-2">
                designed by 
                <a href="https://www.linkedin.com/in/hidirektor/" target="_blank" rel="noopener noreferrer" className="text-text-primary hover:text-primary transition-colors inline-flex items-center group" aria-label="Developer Profile">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="currentColor" stroke="url(#wave-gradient-footer)" strokeWidth="8" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 animate-wave origin-[70%_70%]">
                    <defs>
                      <linearGradient id="wave-gradient-footer" x1="0%" y1="0%" x2="100%" y2="100%">
