        ...
        <div className="bg-surface rounded-[3rem] p-10 md:p-12 border border-border-color shadow-2xl shadow-primary/5 transition-colors duration-300">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-4 border border-border-color rounded-full font-bold text-sm hover:opacity-80 transition-all duration-300 shadow-sm active:scale-[0.98] disabled:opacity-50"
            >
