    ...
    return (
      <div className="min-h-screen bg-[#171923] flex items-center justify-center">
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 border-4 border-black dark:border-white/30 border-t-[#54E6D4] rounded-full animate-spin"></div>
    ...
    <div className="h-screen overflow-hidden bg-[#FEFEFE] dark:bg-[#0B0C10] text-[#101516] dark:text-[#E2E8F0] flex transition-colors duration-500 font-sans selection:bg-black/10 dark:selection:bg-white/10">
      ...
      >
          ...
          {!isSidebarCollapsed ? (
            <>
              ...
              <button 
                ...
                className="absolute top-4 right-4 w-6 h-6 bg-white dark:bg-[#1A1D27] border border-gray-200 dark:border-gray-800 rounded-md flex items-center justify-center text-gray-400 hover:text-[#101516] dark:text-white shadow-sm transition-all hover:scale-110 hidden lg:flex"
                title="Daralt"
              >
        ...
        <div className="p-4 mt-auto">
          ...
          <div className="flex flex-col gap-1 bg-[#F5F7FA] dark:bg-[#1A1D27]/50 rounded-2xl p-2">
            ...
            <button 
              onClick={toggleTheme}
              className={`flex items-center ${isSidebarCollapsed ? 'justify-center p-3' : 'px-4 py-3'} w-full rounded-xl hover:bg-white dark:hover:bg-[#222533] text-gray-600 dark:text-gray-300 hover:text-[#101516] dark:text-white transition-all group`}
              title="Toggle Theme"
            >
      ...
      <div className={`flex-1 flex flex-col transition-all duration-500 ease-[cubic-bezier(0.25,1,0.5,1)] ${isSidebarCollapsed ? 'lg:pl-[88px]' : 'lg:pl-[280px]'} pl-0 h-screen relative w-full overflow-hidden`}>
        ...
        <header className="shrink-0 h-20 bg-white/70 dark:bg-[#12141C]/70 backdrop-blur-2xl border-b border-gray-200/50 dark:border-white/5 relative z-[100] px-4 lg:px-8 flex items-center justify-between w-full shadow-[0_4px_30px_rgba(0,0,0,0.02)]">
          <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-black/10 dark:via-white/10 to-transparent"></div>
          
          <div className="flex items-center gap-4">
            <button 
              onClick={() => setIsMobileSidebarOpen(true)}
              className="lg:hidden w-10 h-10 flex items-center justify-center rounded-xl bg-white dark:bg-[#1A1D27] shadow-sm text-gray-600 dark:text-gray-300 hover:text-[#101516] dark:text-white transition-colors"
            >
              <Menu01Icon size={24} />
            </button>
            <div className="flex items-center gap-3">
              <div className="w-1.5 h-10 bg-gradient-to-b from-black to-gray-800 dark:from-white dark:to-gray-200 rounded-full hidden sm:block shadow-[0_0_10px_rgba(255,107,0,0.3)]"></div>
                 ...
                 <div className="flex items-center gap-3">
                   ...
                   {pathname === '/dashboard/sysop/product-approval' && (
                     <button
                       ...
                       className="flex items-center justify-center w-9 h-9 ml-2 sm:ml-4 rounded-xl bg-white dark:bg-[#1A1D27] shadow-sm border border-gray-100 dark:border-gray-800 text-gray-700 dark:text-gray-300 transition-all hover:shadow-md hover:text-[#101516] dark:text-white hover:-translate-y-0.5"
          ...
          <div className="flex items-center gap-5 relative">
            ...
            <div className="relative">
              <button 
                ...
                className="relative w-11 h-11 flex items-center justify-center rounded-xl bg-white dark:bg-[#1A1D27] shadow-sm border border-gray-100 dark:border-gray-800 text-gray-500 dark:text-gray-400 hover:text-[#101516] dark:text-white transition-all hover:shadow-md hover:-translate-y-0.5 group"
              >
                ...
                {unreadCount > 0 && (
                  <>
                    ...
                    <span className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-[#101516] dark:bg-white rounded-full animate-ping opacity-75"></span>
                  </>
                )}
              </button>
                ...
                <>
                  ...
                  <div className="absolute right-0 top-[calc(100%+12px)] w-80 bg-white dark:bg-[#12141C] border border-gray-100 dark:border-gray-800 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)] z-50 overflow-hidden flex flex-col max-h-[450px] animate-in slide-in-from-top-4 fade-in duration-300">
                    <div className="p-4 border-b border-gray-100 dark:border-gray-800 flex items-center justify-between bg-gray-50/50 dark:bg-black/20">
                      ...
                      <button onClick={handleMarkAllAsRead} className="w-8 h-8 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-500 hover:text-[#101516] dark:text-white transition-colors" title="Tümünü Okundu İşaretle">
                      ...
                      {(() => {
                        ...
                        return unreadNotifs.map((notif: any) => (
                          ...
                          >
                            ...
                            {!notif.isRead && (
                              <div className="absolute right-4 top-1/2 -translate-y-1/2 w-2 h-2 bg-[#101516] dark:bg-white rounded-full shadow-[0_0_8px_rgba(255,107,0,0.6)]"></div>
                            )}
                          </div>
                        ));
                      })()}
            ...
            <div className="relative group">
              ...
              >
                ...
                <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-black to-gray-800 dark:from-white dark:to-gray-200 p-[2px] shadow-sm">
              ...
              <div className={`absolute right-0 top-[calc(100%+8px)] w-64 bg-white dark:bg-[#1A1D27] border border-gray-100 dark:border-gray-800 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-all duration-300 transform origin-top-right z-[110] overflow-hidden 
                ${isProfileMenuOpen ? 'opacity-100 visible scale-100 translate-y-0' : 'opacity-0 invisible scale-95 -translate-y-2'}`}>
                 ...
                 <div className="p-2">
                   <Link href="/dashboard/common/profile" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-[14px] font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-[#101516] dark:text-white dark:hover:text-white transition-all group">
                      <PencilEdit01Icon size={20} className="text-gray-400 group-hover:text-[#101516] dark:text-white dark:group-hover:text-white" />
                      {t('dashboard.edit_profile') || 'Edit Profile'}
                   </Link>
                   
                   <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[14px] font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-[#101516] dark:text-white dark:hover:text-white transition-all group text-left">
                      <RefreshIcon size={20} className="text-gray-400 group-hover:text-[#101516] dark:text-white dark:group-hover:text-white" />
                      {t('dashboard.restart_walkthrough') || 'Restart Walkthrough'}
                   </button>

                   <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-[14px] font-bold text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-white/5 hover:text-[#101516] dark:text-white dark:hover:text-white transition-all group text-left">
                      <BulbIcon size={20} className="text-gray-400 group-hover:text-[#101516] dark:text-white dark:group-hover:text-white" />
        ...
        <main className="flex-1 overflow-y-auto overflow-x-hidden p-2 lg:p-4 animate-in slide-in-from-bottom-4 fade-in duration-500 relative z-0 w-full">
          <div className="w-full mx-auto h-full relative">
            {/* Background Glows for Aesthetic */}
            <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-gray-50 dark:bg-white/5 rounded-full blur-[100px] pointer-events-none mix-blend-screen"></div>
        ...
        <footer className="shrink-0 py-2.5 px-6 border-t border-gray-200/50 dark:border-white/5 bg-white/50 dark:bg-[#12141C]/50 backdrop-blur-md relative z-50">
          <div className="flex items-center justify-center max-w-[1600px] mx-auto relative h-6">
            <div className="text-[11px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest flex items-center gap-2">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 via-gray-400 to-gray-500 dark:from-gray-600 dark:via-gray-500 dark:to-gray-700 bg-[length:200%_auto] animate-[brandShift_3s_ease-in-out_infinite] font-black text-[13px] lowercase tracking-normal drop-shadow-sm">
                salutbabe
              </span>
            </div>
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 flex items-center">
              <div className="group relative ml-2">
                <div className="w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center text-gray-400 hover:text-[#101516] dark:text-white hover:bg-gray-100 dark:bg-white/10 transition-all cursor-help">
      ...
      {toast.visible && (
        <div className="fixed bottom-10 right-10 z-[999] animate-in slide-in-from-right-10 fade-in duration-300">
           <div className={`flex items-center gap-4 px-6 py-4 rounded-3xl border shadow-2xl backdrop-blur-xl min-w-[320px] max-w-md
             ${toast.type === 'warning' 
               ? 'bg-[#101516] dark:bg-white/ dark:bg-[#2A1F16]/90 border-black dark:border-white dark:border-black dark:border-white/ text-[#101516] dark:text-white dark:text-[#101516] dark:text-white shadow-orange-500/10' 
             ...
             <div className={`w-12 h-12 rounded-2xl flex items-center justify-center shrink-0 shadow-sm
               ${toast.type === 'warning' ? 'bg-[#101516] text-white dark:bg-white dark:text-[#101516]' : 'bg-green-500 text-white'}`}>
               {toast.type === 'warning' ? (
                 <Alert01Icon size={24} />
               ) : (
