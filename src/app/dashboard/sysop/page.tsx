      ...
      {userRole === 'founder' ? (
            ...
            <div className={`lg:col-span-2 ${cardClass} p-6 flex flex-col`}>
              <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-8">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <button className={`px-3 py-1.5 rounded-lg border text-[11px] font-bold flex items-center gap-2 ${isDark ? 'border-white/10 text-gray-300 bg-[#1A1D1F]' : 'border-gray-200 text-gray-700 bg-white hover:bg-gray-100'}`}>Tüm Ürünler <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg></button>
                  ...
                  <button className={`px-3 py-1.5 rounded-lg border text-[11px] font-bold flex items-center gap-2 ${isDark ? 'border-white/10 text-gray-300 bg-[#1A1D1F]' : 'border-gray-200 text-gray-700 bg-white hover:bg-gray-100'}`}>2026 <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" /></svg></button>
                  <button onClick={() => router.push('/dashboard/sysop/payout-management')} className={`p-1.5 rounded-lg border flex items-center gap-2 transition-colors ${isDark ? 'border-white/10 text-gray-300 bg-[#1A1D1F] hover:bg-white/10' : 'border-gray-200 text-gray-700 bg-white hover:bg-gray-100'}`}><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg></button>
                </div>
              </div>
              
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-blue-500"></div><span className={`text-[11px] font-bold ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Gelir</span></div>
                  <div className="flex items-center gap-2"><div className="w-2 h-2 rounded-full bg-gray-300"></div><span className={`text-[11px] font-bold ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Hedef</span></div>
                </div>
                <div className="text-[11px] font-bold text-gray-500">Net Satışlar : <span className="text-green-500 font-black">$800.67</span></div>
              </div>
              ...
              <div className="flex-1 min-h-[220px] w-full relative mt-4">
                 ...
                 <svg className="absolute inset-0 w-full h-[85%] preserve-3d" viewBox="0 0 100 100" preserveAspectRatio="none">
                   {/* Target Line (Gray) */}
                   <polyline points="5,40 20,35 35,38 50,30 65,35 80,30 95,25" fill="none" stroke={isDark ? "#374151" : "#E5E7EB"} strokeWidth="1.5" />
                   {/* Revenue Line (Blue) */}
                   <path d="M 5,60 L 20,80 L 35,70 L 50,40 L 65,45 L 80,50 L 95,85" fill="none" stroke="#3B82F6" strokeWidth="2.5" />
                   
                   {/* Data Points Target */}
                   <circle cx="5" cy="40" r="1.5" fill="#FFF" stroke="#D1D5DB" strokeWidth="1" />
                   <circle cx="20" cy="35" r="1.5" fill="#FFF" stroke="#D1D5DB" strokeWidth="1" />
                   <circle cx="50" cy="30" r="1.5" fill="#FFF" stroke="#D1D5DB" strokeWidth="1" />
                   <circle cx="95" cy="25" r="1.5" fill="#FFF" stroke="#D1D5DB" strokeWidth="1" />
                   ...
                   <circle cx="50" cy="40" r="2.5" fill="#3B82F6" stroke="#FFF" strokeWidth="1.5" /> {/* Highlight point */}
                   <circle cx="95" cy="85" r="1.5" fill="#FFF" stroke="#3B82F6" strokeWidth="1.5" />
                 </svg>
                 
                 {/* Dark Tooltip */}
                 <div className="absolute left-[58%] top-[20%] bg-[#1A1D1F] text-white p-3.5 rounded-[12px] shadow-2xl z-10 min-w-[150px]">
                   ...
                   <div className="flex justify-between items-center text-[11px]">
                     ...
                     <span className="font-black text-blue-400">$20,000</span>
                   </div>
                 </div>
            ...
            <div className={`${cardClass} p-6 flex flex-col`}>
              ...
              <div className="flex-1 flex items-end justify-between pb-6 pt-4 relative min-h-[160px]">
                 ...
                 <div className="w-full h-full flex justify-around items-end pl-8 z-10 gap-2">
                   {/* Bar 1: Black striped */}
                   <div className="w-full max-w-[60px] h-[90%] relative rounded-t-lg overflow-hidden flex flex-col justify-end group">
                      <div className="absolute inset-0 bg-[#2E2E3A] dark:bg-white" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 4px, rgba(255,255,255,0.1) 4px, rgba(255,255,255,0.1) 8px)' }}></div>
                   ...
                   {/* Bar 2: Gray striped */}
                   <div className="w-full max-w-[60px] h-[50%] relative rounded-t-lg overflow-hidden flex flex-col justify-end">
                      <div className="absolute inset-0 bg-gray-300 dark:bg-gray-700" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 4px, rgba(0,0,0,0.05) 4px, rgba(0,0,0,0.05) 8px)' }}></div>
                   ...
                   <div className="w-full max-w-[60px] h-[30%] relative rounded-t-lg overflow-hidden flex flex-col justify-end">
                      <div className="absolute inset-0 bg-gray-200 dark:bg-gray-800" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 4px, rgba(0,0,0,0.05) 4px, rgba(0,0,0,0.05) 8px)' }}></div>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between mb-2">
            <div>
              <h2 className={`text-2xl font-black ${isDark ? 'text-white' : 'text-[#1A1D1F]'}`}>Operasyon Merkezi (Ayşe)</h2>
              <p className={`text-[13px] font-medium mt-1 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Günlük operasyonel görevleriniz ve bekleyen iş kuyruklarınız.</p>
            </div>
            <div className="flex items-center gap-3">
               <div className="flex items-center gap-2"><div className="w-2.5 h-2.5 rounded-full bg-red-500 animate-pulse"></div><span className={`text-[12px] font-bold ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>3 Acil Görev</span></div>
            </div>
          </div>
            ...
            <div className={`${cardClass} p-6 relative overflow-hidden group`}>
              <div className="flex items-center justify-between mb-6">
                 <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center">
                    <svg className="w-5 h-5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" /></svg>
                 </div>
                 <button onClick={() => router.push('/dashboard/sysop/shipping-management')} className={`p-1.5 rounded-lg border flex items-center gap-2 transition-colors ${isDark ? 'border-white/10 text-gray-300 bg-[#1A1D1F] hover:bg-white/10' : 'border-gray-200 text-gray-700 bg-white hover:bg-gray-100'}`}><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg></button>
              </div>
              <p className={textTitle}>GECİKEN KARGOLAR</p>
              <h2 className="text-[32px] font-black text-blue-500 mt-1 mb-2">14<span className="text-[16px] text-gray-500 font-bold ml-1">Adet</span></h2>
              <div className="w-full bg-gray-100 dark:bg-white/5 h-1.5 rounded-full mt-4 overflow-hidden">
                 <div className="bg-blue-500 h-full w-[45%] rounded-full"></div>
              </div>
              <p className={`text-[10px] font-bold mt-2 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>%45 PTT Kargo Kaynaklı</p>
            </div>

            {/* Görev: Uyuşmazlık */}
            <div className={`${cardClass} p-6 relative overflow-hidden group border-l-4 border-l-red-500`}>
              <div className="flex items-center justify-between mb-6">
                 ...
                 <button onClick={() => router.push('/dashboard/sysop/order-management')} className={`p-1.5 rounded-lg border flex items-center gap-2 transition-colors ${isDark ? 'border-white/10 text-gray-300 bg-[#1A1D1F] hover:bg-white/10' : 'border-gray-200 text-gray-700 bg-white hover:bg-gray-100'}`}><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg></button>
              </div>
              <p className={textTitle}>AÇIK İHTİLAFLAR (ŞİKAYET)</p>
              <h2 className="text-[32px] font-black text-red-500 mt-1 mb-2">3<span className="text-[16px] text-gray-500 font-bold ml-1">Kayıt</span></h2>
              <div className="w-full bg-gray-100 dark:bg-white/5 h-1.5 rounded-full mt-4 overflow-hidden">
                 <div className="bg-red-500 h-full w-[80%] rounded-full"></div>
              </div>
              <p className={`text-[10px] font-bold mt-2 text-red-500`}>Acil Müdahale Gerekiyor</p>
            </div>
            ...
            <div className={`${cardClass} p-6 relative overflow-hidden group`}>
              <div className="flex items-center justify-between mb-6">
                 <div className="w-10 h-10 rounded-xl bg-orange-50 dark:bg-orange-500/10 flex items-center justify-center">
                    <svg className="w-5 h-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                 </div>
                 <button onClick={() => router.push('/dashboard/sysop/store-management')} className={`p-1.5 rounded-lg border flex items-center gap-2 transition-colors ${isDark ? 'border-white/10 text-gray-300 bg-[#1A1D1F] hover:bg-white/10' : 'border-gray-200 text-gray-700 bg-white hover:bg-gray-100'}`}><svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 19.5l15-15m0 0H8.25m11.25 0v11.25" /></svg></button>
              </div>
              <p className={textTitle}>MAĞAZA ONAY BEKLEYEN</p>
              <h2 className="text-[32px] font-black text-orange-500 mt-1 mb-2">8<span className="text-[16px] text-gray-500 font-bold ml-1">Başvuru</span></h2>
              <div className="w-full bg-gray-100 dark:bg-white/5 h-1.5 rounded-full mt-4 overflow-hidden">
                 <div className="bg-orange-500 h-full w-[25%] rounded-full"></div>
              </div>
              <p className={`text-[10px] font-bold mt-2 ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Pro Satıcı Başvuruları</p>
            </div>
          </div>
          
          <div className={`${cardClass} p-8 flex items-center justify-between`}>
             <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-gray-100 dark:bg-white/10 flex items-center justify-center text-xl">☕</div>
                <div>
                   <p className={`text-[14px] font-bold ${isDark ? 'text-white' : 'text-[#1A1D1F]'}`}>Tüm kuyruklar temiz, harika bir iş çıkarıyorsun Ayşe!</p>
                   <p className={`text-[12px] font-medium ${isDark ? 'text-gray-400' : 'text-gray-500'}`}>Diğer operasyonel görevler için sol menüyü kullanabilirsin.</p>
                </div>
             </div>
          </div>
        </div>
