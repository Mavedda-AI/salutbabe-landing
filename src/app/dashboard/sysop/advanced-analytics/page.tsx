...
import {CheckmarkBadge01Icon, CreditCardIcon, EyeIcon, ShoppingCartIcon} from '@hugeicons/core-free-icons';
...
export default function AdvancedAnalyticsPage() {
  ...
  const getIconForStep = (stepName: string) => {
    ...
    if (lower.includes('sepet')) return <HugeiconsIcon icon={ShoppingCartIcon} className="w-6 h-6 text-[#FF9500]" />;
