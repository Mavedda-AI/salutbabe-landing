...
export default function SystemSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] font-sans">
      {saved && <div className="fixed top-4 right-4 z-[200] bg-green-600 text-white px-5 py-3 rounded-xl text-[13px] font-bold shadow-2xl animate-fade-in"><HugeiconsIcon icon={Tick01Icon} size={16} className="inline-block mr-1" /> Ayarlar başarıyla kaydedildi.</div>}
