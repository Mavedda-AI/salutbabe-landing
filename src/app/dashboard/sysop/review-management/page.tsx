    ...
    <div className="min-h-screen bg-[#F8F9FA] font-sans">
      ...
      <div className="max-w-[1400px] mx-auto px-4 py-6 space-y-6 pb-20">
        ...
        <div className={`${cardClass} p-2 flex gap-1`}>
          {([['pending', <div className="flex items-center gap-1.5"><HugeiconsIcon icon={Timer02Icon} size={16} /> Bekleyen</div>], ['approved', <div className="flex items-center gap-1.5"><HugeiconsIcon icon={Tick01Icon} size={16} /> Onaylanan</div>], ['flagged', <div className="flex items-center gap-1.5"><HugeiconsIcon icon={Flag01Icon} size={16} /> Bayraklı</div>]] ).map(([id, label]: [string, React.ReactNode]) => (
