...
export default function PanelLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen max-w-[100vw] overflow-x-hidden bg-background text-text-primary flex transition-colors duration-300 font-sans selection:bg-primary/20">
          ...
          {!isSidebarCollapsed ? (
            <>
              ...
              <button 
                ...
                className="absolute top-4 right-4 text-white/20 hover:text-white   light:text-text-secondary/20 light:hover:text-text-primary transition-colors md:flex hidden p-1 hover:bg-white/5  light:hover:bg-black/5 rounded-md"
              >
              ...
              <button 
                onClick={() => setIsMobileMenuOpen(false)}
                className="absolute top-4 right-4 md:hidden p-2 text-text-secondary hover:text-text-primary"
              >
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 ${isSidebarCollapsed ? 'md:pl-20' : 'md:pl-72'} pl-0 min-h-screen relative w-full max-w-[100vw] overflow-x-hidden`}>
        ...
        <header className="h-20 bg-white/95  backdrop-blur-md border-b border-border-color sticky top-0 z-[90] px-4 md:px-8 flex items-center justify-between w-full gap-4">
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            <button 
              ...
              className="md:hidden p-2 -ml-2 text-text-primary hover:bg-black/5  rounded-lg transition-colors"
            >
