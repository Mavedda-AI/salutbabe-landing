...
export default function AdminBrandsPage() {
  ...
  return (
    <div className={`rounded-[3rem] border shadow-sm p-12 text-center transition-all ${theme === 'light' ? 'bg-white border-border-color' : 'bg-surface border-white/5'}`}>
      <div className={`w-24 h-24 rounded-3xl flex items-center justify-center mx-auto mb-6 ${theme === 'light' ? 'bg-primary/10 text-primary' : 'bg-primary/20 text-primary shadow-[0_0_30px_rgba(95,200,192,0.1)]'}`}>
