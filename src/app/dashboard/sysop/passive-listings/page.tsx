...
export default function PassiveListingsPage() {
  ...
  const fetchListings = async () => {
    try {
      ...
      const res = await fetch(apiUrl("/admin/listings?status=passive"), {
        headers: { 
  ...
  return (
    <div className="flex flex-col gap-8 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 px-2">
        <h1 className="text-2xl md:text-3xl font-black text-text-primary tracking-tight">Pasif İlanlar</h1>
      </div>
            ...
            {listings.length === 0 ? (
              <tr>
                <td colSpan={5} className="p-12 text-center text-[13px] font-bold text-gray-400 dark:text-white/40">
                  Şu anda sistemde pasif ilana alınmış ürün bulunmuyor.
                </td>
              </tr>
              ...
              <tr key={listing.listingID} className={`transition-colors hover:bg-gray-50 dark:hover:bg-white/5`}>
                ...
                <td className="p-6">
                  <span className={`px-3 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest border bg-gray-100 text-text-secondary border-transparent dark:bg-white/10 dark:text-white`}>
                    Pasif
                  </span>
                </td>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                   ...
                   <div>
                     ...
                     <span className={`px-4 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest border bg-gray-100 text-text-secondary border-transparent dark:bg-white/10 dark:text-white`}>
                        Pasif
                     </span>
                   </div>
                   <div>
