        ...
        <div className="flex-1">
          ...
          {isLoading ? (
            ...
            <p className="text-sm md:text-base font-medium leading-relaxed text-gray-700 dark:text-white/90">
              ...
              İncelenmesi gereken <span className="text-amber-600 dark:text-orange-400 font-bold">{pendingListings} ilan</span> ve satıcılara aktarılması bekleyen <span className="text-indigo-600 dark:text-indigo-400 font-bold">{calculatedTransferPending.toLocaleString('tr-TR', { maximumFractionDigits: 2 })} ₺</span> hakediş bulunuyor. 
