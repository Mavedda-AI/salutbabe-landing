      ...
      <div className={styles.feedContainer}>
        ...
        <div className={styles.priceSection}>
          ...
          <div className={styles.priceGrid}>
            <button className={styles.priceBtn}><span>150 TL</span>Altı</button>
            <button className={styles.priceBtn}><span>300 TL</span>Altı</button>
            <button className={styles.priceBtn}><span>600 TL</span>Altı</button>
