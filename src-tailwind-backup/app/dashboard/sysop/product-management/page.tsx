...
import {AppStore01Icon, PauseCircleIcon, Store01Icon, Tick01Icon} from '@hugeicons/core-free-icons';
...
export default function ProductManagementPage() {
  ...
  const kpis: KPIItem[] = [
    { label: 'TOPLAM İLAN', value: products.length, icon: <HugeiconsIcon icon={AppStore01Icon} size={32} className="text-blue-500" />, colorClass: 'text-blue-500' },
