...
import {Clock01Icon, ShoppingBag01Icon, ShoppingCart01Icon, UserMultipleIcon} from '@hugeicons/react';
...
export default function UserDistributionPage() {
  ...
  const kpiItems = [
    { label: 'TOPLAM KULLANICI', value: '0', icon: <UserMultipleIcon size={24} />, colorClass: 'text-blue-500' },
    { label: 'AKTİF SATICILAR', value: '0', icon: <ShoppingBag01Icon size={24} />, colorClass: 'text-green-500' },
    { label: 'AKTİF ALICILAR', value: '0', icon: <ShoppingCart01Icon size={24} />, colorClass: 'text-purple-500' },
    { label: 'ORT. OTURUM SÜRESİ', value: '0dk', icon: <Clock01Icon size={24} />, colorClass: 'text-orange-500' },
  ];
