        ...
        <div className="mx-auto max-w-7xl transition-all duration-700 ease-in-out backdrop-blur-3xl flex items-center justify-between px-4 sm:px-6 py-3 rounded-4xl bg-white w-full">
          <div className="flex items-center gap-4 sm:gap-8 w-full">
            ...
            <nav className="hidden lg:flex items-center gap-2 flex-1 justify-center">
              <Link className="relative group px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 hover:text-pink-600 text-neutral-600" href="/kurumsal">Kurumsal</Link>
              <Link className="relative group px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 hover:text-pink-600 text-neutral-600" href="/nasil-calisir">Nasıl Çalışır</Link>
              ...
              <Link className="relative group px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 hover:text-pink-600 text-neutral-600" href="/iletisim">İletişim</Link>
            </nav>
